        ...
        collector.on('collect', (m) => {
            ...
            if (confirm) {
                ...
                backup.load(backupID, message.guild,{
                    ...
                    message.author.send('Backup loaded successfully but restoration of message may take a while,after thsi your backup file will be deleted!');
                    backup.remove(backupID); return;
                }).catch((err) => {
